...
const Progress = ({className, maxValue, currentValue, displayNumber, placeholder}: Props) => {
    ...
    return (
        <div className={'w-full h-[25px] relative bg-gray-500 rounded-xl overflow-hidden ' + className}>
            ...
            <div
                className={'absolute h-full w-full inset-0 text-white z-10 items-center justify-center text-center'}>{placeholder || ''} {displayNumber ? maxValue - currentValue : calcPercent() + '%'}</div>
