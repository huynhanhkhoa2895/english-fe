...
const ExerciseTimeout = ({data, handleResult, setStep, step, results}: {
    data: any,
    handleResult: any,
    step: number,
    setStep: any,
                    ...
                    <div className={'w-full'}>
...

                        {
                            _data.map((content: QuestionTimeoutType, index: number) => (
                                step === index &&
                                <ExerciseItemTimeout setStep={setStep} step={step} key={index} content={content}
                                                     handleResult={handleResult} results={results}/>
                            ))
                        }
                    </div>
                )
